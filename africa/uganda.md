...
_Space programs overview_: has a nascent program focused on acquiring remote sensing (RS) satellites for monitoring agricultural usage, land, natural disasters, water bodies, and weather, as well as border security, infrastructure planning, and mineral mapping; has sent personnel to universities in Japan and Russia for technical training for space applications; building a ground station at Mpoma in Mukono for command, control, and management of satellites (2023)<br>
